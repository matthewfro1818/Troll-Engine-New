...
class StageEditorState extends MusicBeatState{
	...
	*/
	...
	{#if discord_rpc
		...
		xPosTxt.setFormat(Paths.font("Normal Text.ttf"), 20, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		xPosTxt.scrollFactor.set();
		xPosTxt.borderSize = 1.25;
		xPosTxt.cameras = [camMenu];

		yPosTxt.setFormat(Paths.font("Normal Text.ttf"), 20, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		yPosTxt.scrollFactor.set();
		yPosTxt.borderSize = 1.25;
		yPosTxt.cameras = [camMenu];

		charTxt.setFormat(Paths.font("Normal Text.ttf"), 20, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
