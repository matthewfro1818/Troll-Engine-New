...
class NotesSubStateWheel extends MusicBeatSubstate
{
	...
	var alphabetR:AlphabetNew;
	var alphabetG:AlphabetNew;
	var alphabetB:AlphabetNew;
	var alphabetHex:AlphabetNew;
	...
	public function new() {
		...
		var text:AlphabetNew = new AlphabetNew(84, 20, '', false);
	...
	// alphabets
	function makeColorAlphabet(x:Float = 0, y:Float = 0):AlphabetNew
	{
		var text:AlphabetNew = new AlphabetNew(x, y, '', true);
		text.alignment = CENTERED;
		text.scaleX = 0.6;
		text.scaleY = 0.6;
		add(text);
	...
	{
		dataArray = ClientPrefs.columnColors;
