...
class QuantNotesSubStateRGB extends MusicBeatSubstate
{
	...
	public function new() {
		...
		for (i in 0...ClientPrefs.quantColors.length) {
			...
			newShader.r = ClientPrefs.quantColors[i][0];
			newShader.g = 0xffffff;
			newShader.b = ClientPrefs.quantColors[i][1];
	...
	function resetValue(selected:Int, type:Int) {
		...
		switch(type) {
			case 0: red.red = resetVal;
			case 1: red.green = resetVal;
			case 2: red.blue = resetVal;
			case 3: blue.red = resetVal;
			case 4: blue.green = resetVal;
			case 5: blue.blue = resetVal;
		}
		...
		shaderArray[selected].r = ClientPrefs.quantColors[selected][0];
		shaderArray[selected].g = 0xffffff;
		shaderArray[selected].b = ClientPrefs.quantColors[selected][1];
	...
	function updateValue(change:Float = 0) {
		...
		shaderArray[curSelected].g = 0xffffff;
