...
class NoteOffsetState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timingTxt.setFormat(Paths.font("Normal Text.ttf"), 28, ratingColor, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		timeTxt.setFormat(Paths.font("Normal Text.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		changeModeText.setFormat(Paths.font("Normal Text.ttf"), 32, FlxColor.WHITE, CENTER);
	...
	function createTexts()
	{
		for (i in 0...6)
		{
			...
			text.setFormat(Paths.font("Normal Text.ttf"), 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, 0xFF000000);
			text.borderSize = 1.5;
			text.cameras = [camHUD];
