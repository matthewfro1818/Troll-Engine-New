...
class ClientPrefs
{
	...
	inline public static function getOptionDefinitions():Map<String, OptionData>
	{
		return [
			...
			"hitsoundType" => {
				...
				value: "Osu",
				data: [
					"options" => ["Osu","Camellia","Clap","Quaver","Stepmania"]
				]
			},
			"missVolume" => {
				display: "Miss Volume",
			...
			"etternaHUD" => {
				...
				value: "Default",
				data: [
					"options" => ["Default", "Advanced", "ITG", "Kade", "Sacorg"]
				]
			},
			"noteType" => {
				display: "Note Skin",
	...
	/*public static var quantColors:Array<Array<Int>> = [
		[0xf9393f, 0xFFFFFFFF, 0x651038], // 4th
		[0x00ffff, 0xFFFFFFFF, 0x004a54], // 8th
		[0xc24b99, 0xFFFFFFFF, 0x3c1f56], // 12th
		[0x12fa05, 0xFFFFFFFF, 0x034415], // 16th

		[0x00ff9d, 0xFFFFFFFF, 0x1580b7], // 20th
		[0xfc73bc, 0xFFFFFFFF, 0x630800], // 24th
		[0xff5c1f, 0xFFFFFFFF, 0x690f3d], // 32nd
		[0x005eff, 0xFFFFFFFF, 0x0d2d73], // 48th

		[0x737373, 0xFFFFFFFF, 0x2e2e2e], // 64th
		[0x00ff9d, 0xFFFFFFFF, 0x1580b7], // 96th
	...
	public static var columnColors:Array<Array<Int>> = [
