function generateModchart(){
	...
	for (i in 0...kicks.length){
        ...
        modManager.queueSetP(step, 'tiny', -25);
        ...
        modManager.queueEaseP(step, step + 4, "tiny", 0, "quadOut");
    }
	...
	modManager.queueFunc(272, 400, function(event, cDS:Float){
        var pos = (cDS - 272) / 4;
	...
	// elastic 2
    modManager.queueEase(456, 460, "centerrotateY", 85, "quadIn", 0);
    modManager.queueEase(460, 470, "centerrotateY", -360 *3, "elasticOut", 0);
    modManager.queueSet(470, "centerrotateY", 0, 0);

    // elastic 3
    modManager.queueEase(488, 492, "centerrotateX", -25, "quadIn", 0);
    modManager.queueEase(492, 500, "centerrotateX", 180, "elasticOut", 0);
    ...
    // elastic 2 tenma
    modManager.queueEase(584, 588, "centerrotateY", 85, "quadIn", 1);
    modManager.queueEase(588, 598, "centerrotateY", -360 * 3, "elasticOut", 1);
    modManager.queueSet(598, "centerrotateY", 0, 1);

    // elastic 3 tenma
    modManager.queueEase(616, 620, "centerrotateX", -25, "quadIn", 1);
    modManager.queueEase(620, 628, "centerrotateX", 180, "elasticOut", 1);
    ...
    modManager.queueEase(912, 914, "centerrotateZ",-5, "cubeOut", 0);
    ...
    modManager.queueEase(916, 918, "centerrotateZ", 10, "cubeOut", 0);
    ...
    modManager.queueEase(920, 922, "centerrotateZ", -15, "cubeOut", 0);
    ...
    modManager.queueEase(924, 926, "centerrotateZ", 0, "cubeOut", 0);
    modManager.queueEaseP(924, 926, "flip", 0, "quadOut", 0);
    modManager.queueEaseP(924, 926, "invert", 0, "quadOut", 0);

	// bounce :)
    modManager.queueFunc(928, 1312, function(event, cDS:Float){
        var s = cDS - 928;
        var beat = s / 4;
    ...
    modManager.queueEaseP(928, 936, "tiny", 25, "quadOut", 0);
    ...
    modManager.queueEaseP(992, 1000, "tiny", 0, "quadOut", 0);
    ...
    modManager.queueEaseP(992, 1000, "tiny", 25, "quadOut", 1);
    ...
    modManager.queueEaseP(1056, 1064, "tiny", 0, "quadOut", 1);
    ...
    modManager.queueEaseP(1056, 1064, "tiny", 25, "quadOut", 0);
    ...
    modManager.queueEaseP(1184, 1192, "tiny", 0, "quadOut", 0);
    ...
    modManager.queueEaseP(1184, 1192, "tiny", 25, "quadOut", 1);
    ...
    modManager.queueSet(1312, "drawDistance", FlxG.height * 10, 0);
    ...
    modManager.queueSetP(1316, "tiny", 0, 1);

    modManager.queueSet(1440, "drawDistance", FlxG.height * 1.1, 0);
    ...
    for(i in 0...4){
        modManager.queueEaseP(1696 + i* 0.5, 1700 + i* 0.5, "reverse" + i, -25, "quadOut");
        modManager.queueEaseP(1700 + i* 0.5, 1702 + i* 0.5, "reverse" + i, 200, "quadIn");
    }
